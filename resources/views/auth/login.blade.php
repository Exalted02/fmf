					...
					<form method="POST" action="{{ route('login') }}">
						...
						<div class="block mt-4">
							<label for="remember_me" class="inline-flex items-center">
								...
								<span class="ms-2 text-gray-600">Do not prompt me with security factors (7 days)</span>
							</label>
						</div>
						...
						<div class="flex mt-4">
							<button type="submit" class="items-center px-4 py-2 bg-color-800 border border-transparent1 rounded-md font-semibold tracking-widest hover:bg-color-700 focus:bg-color-700 active:bg-color-900 focus:outline-none focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 login-common-button">
								Sign in
							</button>
						</div>
						<div class="flex mt-4">
							How to Register Online and Locate Tax Forms
						</div>
						<div class="flex mt-4">
							New User? <a class="ml-3" href="{{route('register')}}"> Register Here</a>
						</div>
					</form>
				</div>
			</div>
