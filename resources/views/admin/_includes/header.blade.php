...
<div class="header">
	...
	<div class="header-left">
		<a href="{{ route('dashboard')}}" class="logo">
			<img src="{{ asset('front-assets/img/-logo1-bw.png') }}" alt="{{ __('project_title') }}" style="max-height: 50px;">
		</a>
		<a href="{{ route('dashboard')}}" class="logo collapse-logo">
			<img src="{{ asset('front-assets/img/-logo1-bw.png') }}" alt="{{ __('project_title') }}">
		</a>
