...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-layout="horizontal" data-sidebar="dark" data-sidebar-size="lg" data-layout-mode="light" data-layout-width="fluid" data-layout-position="fixed" data-layout-style="default" data-topbar="light">
	<head>
		<meta charset="utf-8">
	...
	<body>
		<div class="main-wrapper">
			...
			@endif
			@if(!request()->routeIs('login', 'password.request', 'password.reset', 'verification.notice', 'password.confirm'))
